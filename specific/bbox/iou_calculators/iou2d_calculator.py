...
class BboxOverlaps2D(object):
    ...
    def __call__(self, bboxes1, bboxes2, mode='iou', is_aligned=False):
        ...
        ----------
        bboxes1 : Tensor
            bboxes have shape (m, 4) in <x1, y1, x2, y2>
        ...
        bboxes2 : Tensor
            ...
            equal.
        mode : str
            "iou" (intersection over union), "iof" (intersection
...
def bbox_overlaps(bboxes1, bboxes2, mode='iou', is_aligned=False, eps=1e-6):
    ...
    ----------
    bboxes1 : Tensor
        shape (B, m, 4) in <x1, y1, x2, y2> format or empty.
    bboxes2 : Tensor
        shape (B, n, 4) in <x1, y1, x2, y2> format or empty.
        B indicates the batch dim, in shape (B1, B2, ..., Bn).
        If ``is_aligned `` is ``True``, then m and n must be equal.
    mode : str
        "iou" (intersection over union) or "iof" (intersection over
        foreground).
    is_aligned : bool, optional
        If True, then m and n must be equal.
        Default False.
