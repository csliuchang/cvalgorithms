...
from deepcv2.networks.base.cnn import resize
from deepcv2.networks.base.cnn import ConvModule
from deepcv2.ds_network.builder import HEADS
...
class UPerHead(BaseDecodeHead):
    ...
    def __init__(self, pool_scales=(1, 2, 3, 6), align_corner=False, **kwargs):
