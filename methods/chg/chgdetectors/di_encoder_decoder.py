...
class DualEncoderDecoder(BaseChanger):
    """Dual Input Encoder Decoder Changers.
    ...
    def _init_decode_head(self, decode_head):
        ...
        self.decode_head = builder.build_head(
            decode_head,
    ...
    def extract_feat(self, img):
        ...
        img1, img2 = torch.split(img, self.sep_channel, dim=1)
    ...
    def _auxiliary_head_forward_train(self, x, gt_semantic_seg):
        ...
        if isinstance(self.auxiliary_head, nn.ModuleList):
            ...
            loss_aux = self.auxiliary_head.forward_train(
                x, gt_semantic_seg, self.train_cfg)
    ...
    def forward_train(self, img, ground_truth):
        ...
        gt_masks = ground_truth['mask'].to(img.device)
