...
class GeneralizedAttention(nn.Module):
    ...
    spatial_range : int
        The spatial range. -1 indicates no spatial range
        constraint. Default: -1.
    num_heads : int
        The head number of empirical_attention module.
        Default: 9.
    position_embedding_dim : int
        The position embedding dimension.
        Default: -1.
    position_magnitude : int
        A multiplier acting on coord difference.
        Default: 1.
    kv_stride : int
        The feature stride acting on key/value feature map.
        Default: 2.
    q_stride : int
        The feature stride acting on query feature map.
        Default: 1.
    attention_type : str
        A binary indicator string for indicating which
