...
class OBBFCOSHead(OBBAnchorFreeHead):
    ...
    def get_bboxes(self,
        ...
        for img_id in range(batch_img):
            ...
            det_bboxes = self._get_bboxes_single(cls_score_list,
                                                 ...
                                                 theta_pred_list,
                                                 centerness_pred_list,
                                                 mlvl_points, image_shape, cfg, rescale)
    ...
    def _get_bboxes_single(self,
        ...
        for cls_score, bbox_pred, theta_pred, centerness, points in zip(
            ...
            # TODO max shape
            bboxes = distance2obb(points, bbox_pred, max_shape=image_shape)
        ...
        det_bboxes, det_labels = multiclass_rnms(
            mlvl_bboxes,
            mlvl_scores,
            cfg.score_thr,
            cfg.nms,
