...
from deepcv.pytorch_networks.base.cnn import resize
from ..builder import SEGMENTORS
from ...specific.siamese_layer.builder import build_siamese_layer
from ..criterions import BatchContrastiveLoss
from .. import builder
from .encoder_decoder import EncoderDecoder
import random
import numpy as np
from deepcv.py_utils.logger import sent_msg
